export const QUEUE_NAME = {
  ...
  INCREASE_POSITION_PROCESSOR: 'increase-position-processor',
  DECREASE_POSITION_PROCESSOR: 'decrease-position-processor',
  COMPOSITION_FEES_PROCESSOR: 'composition-fees-processor',
  UPDATE_PAIR_STATIC_FEE_PARAMETERS_PROCESSOR: 'update-pair-static-fee-parameters-processor',
...
export const JOB_TYPES = {
  ...
  PROCESS_UPDATE_PAIR_STATIC_FEE_PARAMETERS: 'process-update-pair-static-fee-parameters',
